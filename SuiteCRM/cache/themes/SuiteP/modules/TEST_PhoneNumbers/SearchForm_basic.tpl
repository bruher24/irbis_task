...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='phone_number_basic' >{sugar_translate label='LBL_PHONE_NUMBER' module='TEST_PhoneNumbers'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.phone_number_basic.value) <= 0}
{assign var="value" value=$fields.phone_number_basic.default_value }
{else}
{assign var="value" value=$fields.phone_number_basic.value }
{/if}
<input type='text' name='{$fields.phone_number_basic.name}'
    id='{$fields.phone_number_basic.name}' size='30'
    maxlength='25'        value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
