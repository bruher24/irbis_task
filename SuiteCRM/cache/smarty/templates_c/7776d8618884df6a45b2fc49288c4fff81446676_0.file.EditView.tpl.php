<?php
/* Smarty version 4.5.5, created on 2025-03-31 00:18:53
  from '/var/www/html/cache/themes/SuiteP/modules/TEST_PhoneNumbers/EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_67e9df6d501ea3_59053932',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7776d8618884df6a45b2fc49288c4fff81446676' => 
    array (
      0 => '/var/www/html/cache/themes/SuiteP/modules/TEST_PhoneNumbers/EditView.tpl',
      1 => 1743380333,
      2 => 'file',
    ),
  ),
...
function content_67e9df6d501ea3_59053932 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/include/Smarty/plugins/modifier.escape.php','function'=>'smarty_modifier_escape',),1=>array('file'=>'/var/www/html/include/Smarty/plugins/function.sugar_include.php','function'=>'smarty_function_sugar_include',),2=>array('file'=>'/var/www/html/include/Smarty/plugins/function.sugar_translate.php','function'=>'smarty_function_sugar_translate',),3=>array('file'=>'/var/www/html/include/Smarty/plugins/block.minify.php','function'=>'smarty_block_minify',),4=>array('file'=>'/var/www/html/include/Smarty/plugins/modifier.strip_semicolon.php','function'=>'smarty_modifier_strip_semicolon',),5=>array('file'=>'/var/www/html/include/Smarty/plugins/function.counter.php','function'=>'smarty_function_counter',),));
?>
...
" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_KEY'];?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=TEST_PhoneNumbers'); return false;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_LABEL'];?>
...
&module_name=TEST_PhoneNumbers", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LNK_VIEW_CHANGE_LOG'];?>
"><?php }
}?>
</div>
</td>
...
<?php echo smarty_function_sugar_translate(array('label'=>'DEFAULT','module'=>'TEST_PhoneNumbers'),$_smarty_tpl);?>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="phone_number">


<div class="col-xs-12 col-sm-2 label" data-label="LBL_PHONE_NUMBER">
...
echo smarty_function_sugar_translate(array('label'=>'LBL_PHONE_NUMBER','module'=>'TEST_PhoneNumbers'),$_smarty_tpl);
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="phone_number" colspan='3' >
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'description', 'text', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DESCRIPTION','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'deleted', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DELETED','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_ID','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'phone_number', 'varchar', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_PHONE_NUMBER','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO','module'=>'TEST_PhoneNumbers','for_js'=>true),$_smarty_tpl);?>
', 'assigned_user_id' );
<?php echo '</script'; ?>
>
<?php }
